######## SEARCH MUSIC SUGESTION ACCORDING TO YOUR  ###########


#####################use this port to run this file#################
...
def get_analysis(start_year, end_year):
    ...
    plt.style.use("Playlist Creator/df-style.mplstyle")
    df2 = pd.read_csv("PLaylist Creator/songs.csv")
...
def main():
    ...
    row0_1.title("Next Favorite Music")
    ...
    df = pd.read_csv("Playlist Creator/playlists.csv")
